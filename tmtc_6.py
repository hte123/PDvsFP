...
for s in swlist:
    for m in matlist:
        mat['_'.join([s,m])]=pd.read_csv('_'.join([s,m])+'_tmt6.csv',index_col=0)
...
for m in matlist:
    ...
    jointplot(mat1,mat2,name='FigureS2B_FPVSPD_'+m+'_jointplot_TMT6.pdf',
    ...
    jointplot(mat1,mat2,name='FigureS2B_FPVSPD_'+m+'_rm_outliers_jointplot_TMT6.pdf',
            labels=swlist,text='('+m+')')
